...
func (m *MockOperationRepository) FindByVIN(arg0 context.Context, arg1 string, arg2 uint64, arg3 string) ([]model.Operation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindByVIN", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].([]model.Operation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockOperationRepositoryMockRecorder) FindByVIN(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByVIN", reflect.TypeOf((*MockOperationRepository)(nil).FindByVIN), arg0, arg1, arg2, arg3)
}
